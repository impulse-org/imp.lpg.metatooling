...
public class OutlineLabelProvider implements ILabelProvider, IColorProvider /*, IPropertyChangeListener (to react to preference changes) */{
	...
	protected JikesPGElementImageProvider fImageLabelProvider;
	private Color fForegroundColor;

	public OutlineLabelProvider(boolean showInheritedMembers, Color foregroundColor) {
	...
	public String getText(Object element) {
	    String result= JikesPGElementLabels.getTextLabel(element, getTextFlags(element));
...
//	}
	...
	public Image getImage(Object element) {
	    Image result= fImageLabelProvider.getImageLabel(element, getImageFlags(element));

-- This is the template which generates a lexer map without
-- functionality for reserved keywords, and it is designed
-- for use with NoKeywordsLexerTemplateF.gi.
-- This template is a copy of LexerBasicMapF.gi with the
-- keyword features removed.
